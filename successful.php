...
<head>
	...
	<script src="asset/getUserMedia.js"> </script>
...
<div class="online-registration">
	<div class="container">
		<div class="row">
			<div class="col-md-12 mb-3 mt-3"><h2 class="text-center heading">Online Registration</h2>
		...
		<div class="row">
		    ...
		    <article>
		        <section class="experiment recordrtc">
		            <video controls playsinline autoplay muted=false volume=1></video>
		               ...
		               <span style="visibility: hidden;"> into</span>
                        ...
                        <div class="group-btn m-t-m-27">
                        <button class="float-left common-btn red-btn">Start Capture</button>
                        <div style="text-left: left; display: none;">
		               
                       <button id="save-to-disk" class="common-btn blue-btn m-l-m-173">Save To Disk</button> 
                       <button id="open-new-tab" style="visibility: hidden;">Open New Tab</button>
		                <button id="upload-to-server" class="common-btn blue-btn save-on-server">Save on Server</button>
			...
			<div class="col-md-3">		
                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <input id="Url" type="text" class="form-control" name="url" value="<?php echo $url; ?>">
                    </div>
                     <div class="form-group">
...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			...
			<p class="text-center">
				Copyright © 2019 NybSys. All Rights Reserved.
			</p>
		</div>
		</div>
	</div>
    ...
    <script>
        ...
        <script>
            ...
            recordingDIV.querySelector('button').onclick = function() {
                ...
                if(button.innerHTML === 'Stop Capture') {
                    ...
                    button.innerHTML = 'Start Capture';
		  ...
		  function captureUserMedia(mediaConstraints, successCallback, errorCallback) {
            ...
            function uploadToServer(recordRTC, callback) {
                ...
                makeXMLHttpRequest(upload_url, formData, function(progress) {
					...
					document.getElementById('Url').value = upload_directory + fileName;
